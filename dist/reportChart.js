...
const dropdown = document.getElementById('week');
...
function getEndDateOfWeek(year, month, week) {
...
dropdown.addEventListener('change', () => {
    ...
    const weeklyReportContainer = document.getElementById('weekly_report');
...
const monthChartBtn = document.getElementById('monthContainer');
monthChartBtn.addEventListener('click', () => {
    const weeklyReportContainer = document.getElementById('monthly_report');
    weeklyReportContainer.innerHTML = "";
    monthData = [];
    const currentMonth = month_expnese[selectedMonth - 1].spending;
    let label;
    ...
    if (monthData.length === 0) {
        ...
        const month_report = document.getElementById('monthly_report');
...
function createCategoryList(data, id) {
